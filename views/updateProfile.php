...
<html lang="en">
<head>
<title>Farmland - Profile page</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					...
					<nav> 
						...
						<?php foreach ($userAllData as $keyvalue) { ?>
						<img src="<?php echo $keyvalue['photo']?>" height="50" width="50" style="margin-top:5px;margin-left:100px;">	
...
<!-- mail -->
	<div class="mail">
		<div class="container">			
			...
			<h3 class="agileits_head">You can update your profile here</h3>
				...
				<form  method="POST" enctype="multipart/form-data">
					...
					<?php foreach ($userAllData as $keyvalue) {
						...
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" type="text" name="fullname" id="input-26" value="<?php echo $keyvalue['fullname'] ?>" placeholder="enter your full name" required="" />
						...
						<span class="input input--ichiro" style="margin-top: 0em; !important">
							<input class="input__field input__field--ichiro" type="email"
							 name="email" id="input-28" value="<?php echo $keyvalue['email'] ?>" placeholder="enter your email " required="" />
						...
						<span class="input input--ichiro" style="margin-top: 2em; !important">
							<input class="input__field input__field--ichiro" type="text" name="mobile" value="<?php echo $keyvalue['mobile'] ?>" id="input-29" placeholder="enter your mobile number " required="" />
						...
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" type="file" id="input-30" name="photo" />
							<label class="input__label input__label--ichiro"  for="input-30">
								<span class="input__label-content input__label-content--ichiro">Select your photo - Previous Selected image : <?php echo $keyvalue['photo'] ?></span>
							</label>
						</span>
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" type="password" 
							id="input-27" name="password" 
							value="<?php echo $keyvalue['password'] ?>" placeholder="enter your password" required="" />
							<label class="input__label input__label--ichiro" for="input-27">
								<span class="input__label-content input__label-content--ichiro">Your Password</span>
							</label>
						</span>
						<span class="input input--ichiro" style="margin-top: 0em; !important">
							<textarea name="address" placeholder="Enter your address here..." required=""><?php echo $keyvalue['address'] ?></textarea>
						</span>
						<input type="submit" name="updateData" value="Update Profile">
					<?php  }   ?>
					</div>
					<div class="col-md-3 w3_agile_mail_grid">
					</div>
