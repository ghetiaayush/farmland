...
?>
		...
		<html lang="en">
		<head>
		<title>Farmland - Your bill</title>
		<!-- for-mobile-apps -->
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					...
					<nav> 
						...
						<a href="viewProfile" style="font-size:15px;margin-top:35px;margin-left:730px;">View profile</a>	
						<?php } ?>				
					</nav>
					<?php
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" >
                ...
                <tbody style="font-size:18px;color:black;"  !important>
                	<?php 
                		$i = 1;
                		if(count($userBillData) > 0 ){
                	foreach ($userBillData as $value) {
                		?>
                	<tr>
                		<td><?php echo $i; ?></td>
                		...
                		<td><?php echo $stts= $value['status']; ?>
                			<a href="paymentPay?bid=<?php echo $value['id']; ?>"><button type="button" class="btn btn-success" style="margin-left: 10px;" <?php if($value['payment'] == "Paid" ){ echo "disabled='disabled'"; }else{ echo "enabled='enabled'"; } ?> >Pay</button>
                		</a></td>
