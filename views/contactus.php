...
<html lang="en">
<head>
<title>Farmland - Contactus page</title>
<!-- for-mobile-apps -->
		...
		<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					...
					<nav> 
						<ul class="nav navbar-nav link-effect-5" id="link-effect-5">
							...
							<li  class="active"><a href="contactus" data-hover="Contact Us">Contact Us</a></li>
...
<!-- mail -->
	<div class="mail">
		<div class="container">
			<div class="agileits_w3layouts_mail">
				<div class="col-md-4 agileits_w3layouts_mail_left">
					<div class="w3_agileits_mail_left">
						...
						<p class="wthree_address">3481 Melrose Place, Ahmedabad, Gujarat, India.</p>
					</div>
				</div>
				<div class="col-md-4 agileits_w3layouts_mail_left">
					<div class="w3_agileits_mail_left">
				...
				<div class="col-md-4 agileits_w3layouts_mail_left">
					<div class="w3_agileits_mail_left">
						...
						<div class="w3_agileits_mail_left1">
							<p class="agileinfo_para">(+000) 123 345 456</p>
					    </div>
					</div>
				</div>
			...
			<h3 class="agileits_head">Contact Us</h3>
			...
			<div class="w3_agile_mail_grids">	
				<form action="" method="POST">
					<div class="col-md-6 w3_agile_mail_grid">
						...
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" type="text" id="input-27" placeholder=" " name="mobile" required="" />
